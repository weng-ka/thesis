...
const METRICS: MetricDef[] = [
  {
    key: 0,
    title: '指标 0：事实一致性',
    description: '摘要是否忠实于原新闻，没有编造事实或改变原意？',
  },
  {
    key: 1,
    title: '指标 1：事件完整性',
    description: '摘要是否交代事件主体、行为、结果和必要背景？',
  },
  {
    key: 2,
    title: '指标 2：权益信息呈现',
    description: '摘要是否指出劳动者身份、可能受损权益和相关责任主体线索？',
  },
  {
    key: 3,
    title: '指标 3：法律依据可追溯性',
    description: '摘要是否能列出违反的法律法规具体内容，而非泛泛使用“违法”等判断？',
  },
  {
    key: 4,
    title: '指标 4：可读性',
    description: '摘要是否语言自然、结构清楚、信息组织合理，不过度堆砌法条？',
  },
]
