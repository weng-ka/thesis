...
Usage:
    ...
    python3 srcs/scripts/summarize_news.py 0099 --rag
    python3 srcs/scripts/summarize_news.py 0099 --structured-only
    python3 srcs/scripts/summarize_news.py 0099 --rag --structured-only
"""
