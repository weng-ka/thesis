...
Usage（專案根目錄）:
    python3 srcs/scripts/bench_02_rag_multimodel.py
    python3 srcs/scripts/bench_02_rag_multimodel.py --limit 10 --models qwen-max deepseek-v3
    python3 srcs/scripts/bench_02_rag_multimodel.py --overwrite
"""
